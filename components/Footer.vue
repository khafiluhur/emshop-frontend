<template>
    <div class="mx-12 my-5">
        <div class="mb-10">
            <div class="row" style="">
            <div class="col-9">
                <p class="text-start fw-bold text-title-parsial mb-4" style="font-size: 14px"
                >
                PAYMENT
                </p>
                <div class="row pb-3">
            ...
            <div class="col-3 ps-5">
                <p class="fw-bold text-title-parsial text-start mb-4" style="font-size: 14px"
                >
                COURIER
                </p>
                <div class="row pb-3">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-social mb-5">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-5">
                        <p class="text-start fw-bold text-title-parsial mb-2">
                            PART OF
                        </p>
                        <div class="row pb-0">
